...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'my.firebase_listner' => 'getMy_FirebaseListnerService',
            ...
            'procash.verifier_droit' => 'getProcash_VerifierDroitService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.controller', array(0 => 'procash.verifier_droit', 1 => 'onKernelController'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'postPersist'), $this->get('my.firebase_listner'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'procash', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Procash\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Procash\\AdministrationBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Procash\\GestionBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Procash\\UserBundle\\Entity');
        $c->addDriver($b, 'Procash\\AdministrationBundle\\Entity');
        $c->addDriver($b, 'Procash\\GestionBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('ProcashUserBundle' => 'Procash\\UserBundle\\Entity', 'ProcashAdministrationBundle' => 'Procash\\AdministrationBundle\\Entity', 'ProcashGestionBundle' => 'Procash\\GestionBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_795cba7e1903c354a530053137ed1e5e2635ca43ee9a51f55c2962c2c6d54115');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Procash\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Procash\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Procash\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Procash\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Procash\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['lexik_jwt_authentication.jwt_encoder'] = new \Lexik\Bundle\JWTAuthenticationBundle\Encoder\JWTEncoder(($this->targetDirs[2].'/var/jwt/private.pem'), ($this->targetDirs[2].'/var/jwt/public.pem'), 'Google75');
    }
    ...
    /**
     * Gets the 'my.firebase_listner' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Procash\GestionBundle\EventListener\FirebaseUpdate A Procash\GestionBundle\EventListener\FirebaseUpdate instance.
     */
    protected function getMy_FirebaseListnerService()
    {
        return $this->services['my.firebase_listner'] = new \Procash\GestionBundle\EventListener\FirebaseUpdate($this);
    }
    ...
    {
        return $this->services['nelmio_cors.options_provider.config'] = new \Nelmio\CorsBundle\Options\ConfigProvider(array('paths' => array(), '^/api/' => array('allow_origin' => true, 'allow_headers' => true, 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE', 4 => 'OPTIONS'), 'max_age' => 3600)), array('allow_origin' => true, 'allow_credentials' => true, 'allow_headers' => true, 'expose_headers' => array(), 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE', 4 => 'OPTIONS'), 'max_age' => 0, 'hosts' => array(), 'origin_regex' => false));
    }

    /**
     * Gets the 'procash.verifier_droit' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Procash\AdministrationBundle\DroitChecker\DroitListener A Procash\AdministrationBundle\DroitChecker\DroitListener instance.
     */
    protected function getProcash_VerifierDroitService()
    {
        return $this->services['procash.verifier_droit'] = new \Procash\AdministrationBundle\DroitChecker\DroitListener($this->get('security.context'), $this->get('doctrine.orm.default_entity_manager'), $this->get('controller_resolver'), $this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Procash\AdministrationBundle\Redirection\AfterLoginRedirection A Procash\AdministrationBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \Procash\AdministrationBundle\Redirection\AfterLoginRedirection($this->get('router'), $this->get('doctrine.orm.default_entity_manager'), $this->get('session'), $this->get('security.context'));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/login'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    {
        $a = new \Lexik\Bundle\JWTAuthenticationBundle\Security\Firewall\JWTListener($this->get('security.token_storage'), $this->get('security.authentication.manager'), array('authorization_header' => array('enabled' => true, 'prefix' => 'Bearer', 'name' => 'Authorization'), 'cookie' => array('enabled' => false, 'name' => 'BEARER'), 'query_parameter' => array('enabled' => false, 'name' => 'bearer'), 'throw_exceptions' => false, 'create_entry_point' => true, 'authentication_provider' => 'lexik_jwt_authentication.security.authentication.provider', 'authentication_listener' => 'lexik_jwt_authentication.security.authentication.listener'));
        $a->addTokenExtractor(new \Lexik\Bundle\JWTAuthenticationBundle\TokenExtractor\AuthorizationHeaderTokenExtractor('Bearer', 'Authorization'));
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, '/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        ...
        $l = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, $this->get('security.authentication.session_strategy'), $e, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('redirect.after.login'), array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => false, 'use_referer' => true, 'default_target_path' => '/', 'target_path_parameter' => '_target_path'), 'main'), $k, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $c, $d, $this->get('security.csrf.token_manager'));
        $l->setRememberMeServices($i);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b, 1 => $h), 'main', $c, $d), 2 => $j, 3 => $l, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $i, $g, $c, $d, true), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '58a6b03655155', $c, $g), 6 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($a, $b, $this->get('security.user_checker'), 'main', $this->get('security.access.decision_manager'), $c, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $d), 7 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'fos_user_security_login', false), NULL, NULL, $c));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Procash\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Procash\\AdministrationBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Procash\\MenuBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Procash\\GestionBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Procash\\ApiBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Procash\\UserBundle/Resources/views'), 'ProcashUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Procash\\AdministrationBundle/Resources/views'), 'ProcashAdministration');
        $instance->addPath(($this->targetDirs[3].'\\src\\Procash\\MenuBundle/Resources/views'), 'ProcashMenu');
        $instance->addPath(($this->targetDirs[3].'\\src\\Procash\\GestionBundle/Resources/views'), 'ProcashGestion');
        $instance->addPath(($this->targetDirs[3].'\\src\\Procash\\ApiBundle/Resources/views'), 'ProcashApi');
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/administration'), array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/referentiel'), array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/rest'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($b, $c, 'login', $d, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58a6b03655155'), 2 => $e, 3 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($b, $c, 'main', $d, true), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($c, 'ThisTokenIsNotSoSecretChangeIt', 'main'), 5 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58a6b03655155')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'ROLE_ALLOWED_TO_SWITCH'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_EVENT_CREATE'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ProcashUserBundle' => 'Procash\\UserBundle\\ProcashUserBundle',
                'ProcashAdministrationBundle' => 'Procash\\AdministrationBundle\\ProcashAdministrationBundle',
                'ProcashMenuBundle' => 'Procash\\MenuBundle\\ProcashMenuBundle',
                'ProcashGestionBundle' => 'Procash\\GestionBundle\\ProcashGestionBundle',
                'LexikJWTAuthenticationBundle' => 'Lexik\\Bundle\\JWTAuthenticationBundle\\LexikJWTAuthenticationBundle',
                'NelmioCorsBundle' => 'Nelmio\\CorsBundle\\NelmioCorsBundle',
                'ProcashApiBundle' => 'Procash\\ApiBundle\\ProcashApiBundle',
            ...
            'jwt_key_pass_phrase' => 'Google75',
            'jwt_token_ttl' => 86400,
            'default_url' => 'https://procash-df72a.firebaseio.com/',
            'default_token' => 'lcU2GBfD3nVPXRojOfGJfj5SWsuEK686tre956E1',
            'default_path' => '/dev-md/',
            'ftp_user' => 'dev-md',
            'ftp_pwd' => 'Dev674.',
            'ftp_host' => 'dev-md.nacre-solutions.com',
            ...
            'fos_user.model.user.class' => 'Procash\\UserBundle\\Entity\\User',
            ...
            'lexik_jwt_authentication.pass_phrase' => 'Google75',
