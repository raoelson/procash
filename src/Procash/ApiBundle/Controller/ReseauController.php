...
class ReseauController extends Controller {
    ...
    public function getReseauxAction() {
        $reseaux = $this->getDoctrine()->getManager()->getRepository("ProcashAdministrationBundle:Reseau")->findByDateSuppression(null);
        $response = new Response();
        $reseauxTab = array();
    ...
    public function getClientsAction() {
        ...
        $clients = $this->getDoctrine()->getManager()->getRepository("ProcashAdministrationBundle:Client")->findByDateSuppression(null);
        $response = new Response();
        $clientsTab = array();
        ...
        foreach ($clients as $client) {
            array_push(
                ...
                'code_client' => ($client->getCodeClient() != null) ? $client->getCodeClient() : '-',
                    )
            );
        }
